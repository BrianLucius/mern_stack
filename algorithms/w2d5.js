...
console.log("Naughty List:", santasNaughtyList(students, badHabit1))
console.log("Naughty List:", santasNaughtyList(students, badHabit2))
console.log("Naughty List:", santasNaughtyList(students, badHabit3))

console.log("Naughty List Functional:", santasNaughtyListFunctional(students, badHabit1))
console.log("Naughty List Functional:", santasNaughtyListFunctional(students, badHabit2))
console.log("Naughty List Functional:", santasNaughtyListFunctional(students, badHabit3))
