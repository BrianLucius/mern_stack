...
class Product {
  ...
  */
  ...
  function mergeCarts(shoppingCart, wishList) {
    if (shoppingCart.length===0) return wishList;
  ...
  function mergeCarts_ruben(shoppingCart = [], wishList = []) {
...
console.log("Test Case 1:", mergeCarts(shoppingCart1, wishList1));
console.log("Test Case 2:", mergeCarts(shoppingCart2, wishList2));
console.log("Test Case 3:", mergeCarts(shoppingCart3, wishList3));
console.log("Test Case 4:", mergeCarts(shoppingCart4, wishList4));

console.log("Test Case 1:", mergeCarts_ruben(shoppingCart1, wishList1));
console.log("Test Case 2:", mergeCarts_ruben(shoppingCart2, wishList2));
console.log("Test Case 3:", mergeCarts_ruben(shoppingCart3, wishList3));
console.log("Test Case 4:", mergeCarts_ruben(shoppingCart4, wishList4));
  /*****************************************************************************/